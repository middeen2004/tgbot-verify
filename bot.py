...
async def error_handler(update: object, context) -> None:
    ...
    logger.exception("Exception while handling an update: %s", context.error, exc_info=context.error)
...
def main():
    ...
    # Create application - enable concurrent updates
    application = (
        Application.builder()
        .token(BOT_TOKEN)
        .concurrent_updates(True)  # Enable concurrent processing of multiple commands
        .build()
    )

    # Register user commands (use partial to pass db)
